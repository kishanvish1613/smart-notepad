...
class Notepad:
    def __init__(self):
        ...
        self.root.wm_iconbitmap('D:/smartnotepad/icons/icons/root.ico')
        ...
        self.root.protocol("WM_DELETE_WINDOW", self.exit_function)

    def set_icons(self):
        self.new_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/new.png')
        self.open_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/open.png')
        self.save_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/save.png')
        self.save_as_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/save_as.png')
        self.exit_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/exit.png')
        self.copy_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/copy.png')
        self.paste_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/paste.png')
        self.cut_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/cut.png')
        self.clear_all_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/clear_all.png')
        self.find_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/find.png')
        self.tool_bar_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/tool_bar.png')
        self.status_bar_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/status_bar.png')
        self.light_default_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/light_default.png')
        self.light_plus_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/light_plus.png')
        self.dark_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/dark.png')
        self.red_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/red.png')
        self.monokai_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/monokai.png')
        self.night_blue_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/night_blue.png')
    ...
    def set_tool_bar(self):
        ...
        ## align right
        self.align_right_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/align_right.png')
        self.align_right_btn = ttk.Button(self.tool_bar, image=self.align_right_icon)
        self.align_right_btn.grid(row=0, column=8, padx=5)
        ## mike
        self.mike_icon = tk.PhotoImage(file='D:/smartnotepad/icons/icons/microphone.png')
    ...
    def find_func(self, event=None):
        ...
        self.find_dialogue.geometry('300x150+500+200')
    ...
    def say_something(self):
        try:
            ...
            if self.takeAudio == "":
                ...
                self.save_as()
            elif self.takeAudio.lower() == 'close app':
                self.exit_function()
            elif self.takeAudio.lower() == 'text bold':
                self.change_bold()
            elif self.takeAudio.lower() == 'text italic':
                self.change_italic()
